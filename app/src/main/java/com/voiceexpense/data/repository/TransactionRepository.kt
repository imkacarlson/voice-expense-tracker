...
class TransactionRepository(
    ...
    // Placeholder - implemented after Sheets client and worker
    suspend fun syncPending(): SyncResult {
        throw UnsupportedOperationException("syncPending will be implemented after SheetsClient integration")
    }
